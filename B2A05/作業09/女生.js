...
lib.ssMetadata = [
		{name:"B2A女生_HTML5 Canvas_atlas_1", frames: [[0,0,623,434],[0,436,278,280],[581,467,153,408],[625,0,180,465],[280,669,192,322],[0,718,231,138],[280,436,299,231],[474,877,312,103],[474,669,54,128]]}
];
...
(lib.CachedBmp_18 = function() {
	this.initialize(ss["B2A女生_HTML5 Canvas_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.手, new cjs.Rectangle(0,0,188.4,457.4), null);


// stage content:
(lib.B2A女生_HTML5Canvas = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
// library properties:
lib.properties = {
	id: '0B861BF5EAD1EE46B79748A718C0B074',
	width: 474,
	height: 506,
	fps: 30,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/圖層3.png?1765810931436", id:"圖層3"},
		{src:"images/B2A女生_HTML5 Canvas_atlas_1.png?1765810931394", id:"B2A女生_HTML5 Canvas_atlas_1"}
	],
	preloads: []
};
...
an.compositions['0B861BF5EAD1EE46B79748A718C0B074'] = {
